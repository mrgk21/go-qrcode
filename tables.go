...
var capacity = map[int]map[ErrorCorrection]*charCapacity{
	1: {
		L: &charCapacity{correction: L, numeric: 41, alpha: 25, byteMode: 17, ecCodewords: 7, totalCodewords: 19},
		M: &charCapacity{correction: M, numeric: 34, alpha: 20, byteMode: 14, ecCodewords: 10, totalCodewords: 16},
		Q: &charCapacity{correction: Q, numeric: 27, alpha: 16, byteMode: 11, ecCodewords: 13, totalCodewords: 13},
		H: &charCapacity{correction: H, numeric: 17, alpha: 10, byteMode: 7, ecCodewords: 17, totalCodewords: 9},
	},
}
